...
<div class="container result-page">
    ...
    <div class="row row-results">
        ...
        <div class="col-md-7">
            ...
            <h2>
                <a href="#callback" class="call_consult">Заказать консультацию</a><br><br>
    ...
    <!-- Всплывающие окно по клику -->
    <div class="hidden ppopup-form">
        ...
        <form class="callback" id="callback"> 
            ...
            <div class="container">
                <div class="row">
                    ...
                    <h1>Заказав консультацию вы сможете разобраться в чем проблема вашего сайта, а так же понять пути его
                развития</h1>
                        <div class="window-magnif">
                        <button title="Close (Esc)" type="button" class="mfp-close close-consult">×</button>

                        <input type="hidden" name="project_name" value="http://russia-seo.ru/">
                        <input type="hidden" name="admin_email" value="fed140493@yandex.ru">
                        <input type="hidden" name="form_subject" value="Заявка с сайта Анализатора.">

                            <input type="text" name="Имя" placeholder="Ваше имя" class="formInput">
                            <input type="number" name="Номер" placeholder="Ваш номер телефона" class="formInput">
                            <input type="submit" name="formsub" class="formsub" value="Отправить">
                            <input type="hidden" name="site" value="<?php print $link ?>">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Всплывающие окно по автоматически -->
    <div class="hidden ppopup-form">
        
        <form class="autocallback" id="autocallback"> 
            
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                    <h1 id="autocall-h1">Оставьте заявку чтобы увидеть результаты анализа!</h1>
                    <div class="window-auto-call">
                    <h2 id="autocall-h2">Оставить заявку</h2>

                    <input type="hidden" name="project_name" value="http://russia-seo.ru/">
                    <input type="hidden" name="admin_email" value="fed140493@yandex.ru">
                    <input type="hidden" name="form_subject" value="Заявка с сайта Анализатора.">

                            <input type="text" name="Имя" placeholder="Ваше имя" class="formInputAutoCallback">

                            <input type="email" name="Почта" placeholder="Ваш email" class="formInputAutoCallback">

                            <input type="number" name="Номер телефона" placeholder="Мобильный телефон" class="formInputAutoCallback">

                            <input type="submit" name="autoCallbackSub" class="autoCallbackSub" value="Отправить заявку">
...
<script type="text/javascript" href="../assets/js/jquery.magnific-popup.min.js"></script>
...
<script type="text/javascript">
    ...
    function timeWindow() {
        $.magnificPopup.open({
        items: {
           src: $('#autocallback'), // can be a HTML string, jQuery object, or CSS selector                
        },
        type: 'inline',
    ...
    setTimeout(timeWindow, 10); 


        $("#autocallback").submit(function() { //Change
        var th = $(this);
        $.ajax({
            type: "POST",
            url: "mail.php", //Change
